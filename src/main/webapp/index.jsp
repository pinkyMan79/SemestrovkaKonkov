...
<h1>Sign Up Form</h1>
<div id="wrapper">
    <form id="signin" method="post" action="<c:url value="/hello"/>" autocomplete="off">
        <input type="text" id="email" name="email" placeholder="email" />
        <input type="text" id="username" name="username" placeholder="username" />
        <input type="password" id="pass" name="pass" placeholder="password" />
        <input type="password" id="re_pass" name="re_pass" placeholder="repeat password" />
        <button type="submit">&#xf0da;</button>
        <p>Already have an account? -><a href="${pageContext.request.contextPath}/login.jsp">click here</a></p>
    </form>
</div>
</body>
</html>
